        ...
        private static void initialiseCommands()
        {
            ...
            commands.CreateCommand("hostgame")                                      
                    ...
                    .Do(async e =>                                                  
                    {
                        ...
                        if (e.User.Nickname != null)
                            user = ds.getPlayer(e.User.Id, e.User.Nickname, e.User.NicknameMention);
                        else
                            user = ds.getPlayer(e.User.Id, e.User.Name, e.User.Mention);
            ...
            commands.CreateCommand("leave")
                    ...
                    .Do(async e =>
                    {
                        ...
                        Player user;
                        if (e.User.Nickname != null)
                            user = ds.getUser(e.User.Id, e.User.Nickname, e.User.NicknameMention, e.User);
                        else
                            user = ds.getUser(e.User.Id, e.User.Name, e.User.Mention, e.User);
