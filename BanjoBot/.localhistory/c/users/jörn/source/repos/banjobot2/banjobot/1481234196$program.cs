...
namespace BanjoBot
{
    class Program
    {
        public const ulong D2_BBL_SERVER_ID = 175510313754427392;
        public static DataStore ds;
        private static LeagueController lc;
        ...
        static void Main(string[] args)
        {
            ...
            Server server = bot.GetServer(D2_BBL_SERVER_ID);
            lc = new LeagueController(server);
        ...
        private static void initialiseCommands()
        {
            ...
            commands.CreateCommand("hostgame")                                      
                    ...
                    .Do(async e =>                                                  
                    {
                        ...
                        await lc.hostGame(e.Channel, user);
                    });
            ...
            commands.CreateCommand("join")
                    ...
                    .Do(async e =>
                    {
                        ...
                        await lc.joinGame(e.Channel, user);
                    });
            ...
            commands.CreateCommand("leave")
                    ...
                    .Do(async e =>
                    {
                        ...
                        await lc.leaveGame(e.Channel, user);
                    });
            ...
            commands.CreateCommand("cancelgame")
                    ...
                    .Do(async e =>
                    {
                        ...
                        await lc.cancelGame(e.Channel, user);
                    });
            ...
            commands.CreateCommand("votecancel")
                    ...
                    .Do(async e =>
                    {
                        ...
                        await lc.voteCancel(e.Channel, user);
                    });
            ...
            commands.CreateCommand("startgame")
                    ...
                    .Do(async e =>
                    {
                        ...
                        await lc.startGame(e.Channel, user);
                    });
            ...
            commands.CreateCommand("getplayers")
                    ...
                    .Do(async e =>
                    {
                        await lc.listPlayers(e.Channel);
                    });
            ...
            commands.CreateCommand("getstats")
                    ...
                    .Do(async e =>
                    {
                        ...
                        await lc.getStats(e.Channel, ds, e.GetArg("target"));
                    });
            ...
            commands.CreateCommand("bluewins")
                    ...
                    .Do(async e =>
                    {
                        ...
                        await lc.voteWinner(e.Channel, user, Teams.Blue);
                    });
            ...
            commands.CreateCommand("redwins")
                    ...
                    .Do(async e =>
                    {
                        ...
                        await lc.voteWinner(e.Channel, user, Teams.Red);
                    });
            ...
            commands.CreateCommand("draw")
                    ...
                    .Do(async e =>
                    {
                        ...
                        await lc.voteWinner(e.Channel, user, Teams.Draw);
                    });
            ...
            commands.CreateCommand("topmmr")
                    ...
                    .Do(async e =>
                    {
                        await lc.getTopMMR(e.Channel, ds);
                    });
