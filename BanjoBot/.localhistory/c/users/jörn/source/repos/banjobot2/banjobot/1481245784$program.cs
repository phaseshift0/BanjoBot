...
namespace BanjoBot
{
    class Program
    {
        private const ulong D2_BBL_SERVER_ID = 175510313754427392;
        ...
        static void Main(string[] args)
        {
            ...
            Server server = _bot.GetServer(D2_BBL_SERVER_ID);
            _ls = new LeagueController(server);
            ...
            _bot.ExecuteAndWait(async () => {
                ...
                } while (_bot.State != ConnectionState.Connected);
        ...
        private static void initialiseCommands()
        {
            ...
            commands.CreateCommand("hostgame")                                      
                    ...
                    .AddCheck(CheckIfRegistered, "This is no league channel. Join " + _allLeagues + " and try again")
                    .Do(async e =>                                                  
                    {
                        // Get or create user
                        Player user;
