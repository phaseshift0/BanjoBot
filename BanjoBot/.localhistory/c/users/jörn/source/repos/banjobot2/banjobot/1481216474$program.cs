...
namespace BanjoBot
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Login to Discord
            //Task<string> loginStatus = botLogin(false);
            ...
            bot.ExecuteAndWait(async () => {
                ...
                do {
                    ...
                    try {
                    String s = await bot.Connect(email, password);
                    Console.WriteLine("\n." + s);
            ...
            //    Console.WriteLine("pls mercy " + loginStatus.Status);
        ...
        private static Task<string> Login(bool test) {
            if (!test) {
                // Login to Discord
                Console.WriteLine("Please enter the bot's login credentials.");
                Console.Write("Email: ");
